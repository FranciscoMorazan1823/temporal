...
import { Group2187Icon } from './Group2187Icon';
import { Group2188Icon } from './Group2188Icon';
import classes from './GruposEditarGrupoMenuDelUsuari.module.css';
...
interface Props {
  ...
  classes?: {
    ...
    eNCUESTAS2?: string;
    pERFIL2?: string;
    cERRARSESION2?: string;
  };
}
export const GruposEditarGrupoMenuDelUsuari: FC<Props> = memo(function GruposEditarGrupoMenuDelUsuari(props = {}) {
  return (
    <div className={`${classes.root} ${props.className || ''}`}>
      ...
      <div className={`${classes.guardarCambios} ${props.classes?.guardarCambios || ''}`}>Guardar cambios</div>
      ...
      <div className={`${classes.editarGrupo} ${props.classes?.editarGrupo || ''}`}>Editar grupo</div>
      ...
      <Group2187Icon className={`${classes.group2187} ${props.classes?.group2187 || ''}`} />
      <div className={`${classes.gRUPOS} ${props.classes?.gRUPOS || ''}`}>GRUPOS</div>
      <div className={`${classes.eNCUESTAS} ${props.classes?.eNCUESTAS || ''}`}>ENCUESTAS</div>
      <div className={`${classes.pERFIL} ${props.classes?.pERFIL || ''}`}>PERFIL</div>
      <div className={`${classes.cERRARSESION} ${props.classes?.cERRARSESION || ''}`}>CERRAR SESIÓN</div>
      <Group2188Icon className={`${classes.group2188} ${props.classes?.group2188 || ''}`} />
      <div className={`${classes.gRUPOS2} ${props.classes?.gRUPOS2 || ''}`}>GRUPOS</div>
      <div className={`${classes.eNCUESTAS2} ${props.classes?.eNCUESTAS2 || ''}`}>ENCUESTAS</div>
      <div className={`${classes.pERFIL2} ${props.classes?.pERFIL2 || ''}`}>PERFIL</div>
      <div className={`${classes.cERRARSESION2} ${props.classes?.cERRARSESION2 || ''}`}>CERRAR SESIÓN</div>
    </div>
  );
});
